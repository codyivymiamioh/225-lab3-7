pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/ivyca'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/codyivymiamioh/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('ivyca-225')                                                         //<------your MiamiID
    }
